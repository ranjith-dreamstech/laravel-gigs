...
class SubCategoryRequest extends FormRequest
{
     ...
     *
     * @return array<string, string> The validation rules for the subcategory request.
     */
    public function rules()
    {
        ...
        return [
            ...
            'slug' => 'required|string|max:100|unique:categories,slug' . ($isUpdate ? ',' . $subCategoryId : ''),
    ...
    public function messages(): array
    {
        return [
            ...
            'category_id.required' => __('admin.common.category_required'),
        ];
    }
}
