        ...
        <div class="content me-4">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                <div class="my-auto mb-2">
                    <h4 class="mb-1">{{ __('admin.common.category') }}</h4>
                    <nav>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item">
                                <a href="{{ route('dashboard') }}">{{ __('admin.common.home') }}</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">{{ __('admin.common.category') }}</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="mb-2">
                            ...
                            <a href="javascript:void(0);"
                                ...
                                data-bs-toggle="modal" data-bs-target="#add_category_modal"><i
                                    class="ti ti-plus me-2"></i>{{ __('admin.manage.add_new_category') }}</a>
                ...
                <table class="table" id="categoryTable">
                    <thead class="thead-light">
                        <tr>
                            ...
                            @if (hasPermission($permissions, 'category', 'edit') || hasPermission($permissions, 'menu_management', 'delete'))
            ...
            <form id="categoryForm" autocomplete="off">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="mb-0">{{ __('admin.manage.create_category') }}</h5>
                    ...
                    <div class="modal-body pb-1 customer-modal-scroll">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="language_id" class="form-label">{{ __('admin.common.language') }}<span
                                            class="text-danger"> *</span></label>
                                    <select class="form-select" id="language_id" name="language_id">
                                        @foreach ($languages as $language)
                                            <option value="{{ $language->language_id }}">
    ...
    <div class="modal fade" id="editCategoryModal">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <form id="editcategoryForm" autocomplete="off">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="mb-0">{{ __('admin.manage.edit_category') }}</h5>
                        <button type="button" class="btn-close custom-btn-close" data-bs-dismiss="modal"
                            aria-label="Close">
                            <i class="ti ti-x fs-16"></i>
                        </button>
            ...
            <div class="modal-content">
                <form id="deleteCategoryForm">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <h4 class="mb-1">{{ __('admin.manage.delete_category') }}</h4>
                        <p class="mb-3">{{ __('admin.manage.delete_category_confirmation') }}</p>
                        <div class="d-flex justify-content-center">
                            <a href="javascript:void(0);" class="btn btn-light me-3"
                                data-bs-dismiss="modal">{{ __('admin.common.cancel') }}</a>
...
@push('scripts')
    <script src="{{ asset('backend/assets/js/category/category.js') }}"></script>
@endpush
