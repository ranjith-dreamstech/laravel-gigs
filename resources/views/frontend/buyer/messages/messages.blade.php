                                    ...
                                    <li class="user-list-item chat-user-list" data-userid="{{ $user->id }}">
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="users-list-body">
                                                <div>
                                                    <h5>{{ $user->userDetail ? $user->userDetail->first_name . ' ' . $user->userDetail->last_name : $user->name }}</h5>
                    ...
                    <div class="h-100">
                        <div class="chat-header">
                            <div class="user-details mb-0">
                                ...
                                <div class="mt-1">
                                    <h5 class="chat-username" aria-label="{{ __('web.user.chat_with') }} {{ $authUser->name }}">Chat with
                                    </h5>
                                </div>
                            </div>
                        </div>
...
<script src="{{ asset('frontend/custom/js/buyer/messages.js') }}"></script>
@endpush
