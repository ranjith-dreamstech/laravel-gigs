...
<body data-theme={{ $theme ?? 1}} data-dir="{{ $isRTL ? 'rtl' : 'ltr' }}" @if(request()->routeIs('buyer.messages'))
    class="chat-page main-chat-blk" @endif>

    <!-- Main Wrapper -->
    <div class="main-wrapper @if(request()->routeIs('buyer.messages')) chat-wrapper @endif">
        @include('frontend.buyer.partials.header')
        @include('frontend.buyer.partials.sidebar')
        @yield('content')
        ...
        <div class="back-to-top">
            <a class="back-to-top-icon align-items-center justify-content-center d-flex" href="#top"
                ...
                <img src="/frontend/assets/img/icons/arrow-badge-up.svg" alt="">
            </a>
        </div>
        <!-- /Top Scroll -->
