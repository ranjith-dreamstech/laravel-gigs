...
<div class="page-wrapper">
    <div class="page-content content">
        ...
        <div class="row seller-list d-none real-card" id="my_buyers_list">
           
        </div>
        <div class="text-center d-none real-card">
            <button type="button" class="btn btn-lg btn-dark d-inline-flex align-items-center load_more_btn d-none"><i class="ti ti-loader-3 me-2"></i>Load More</button>
        </div>
    </div>
</div>
<!-- /Page Content -->
...
@push('scripts')
<script src="{{ asset('frontend/custom/js/my-buyers.js') }}"></script>
@endpush
