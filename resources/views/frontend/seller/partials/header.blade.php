        ...
        <div class="header-right d-flex align-items-center">
            <div class="dashboard-link">
                <ul class="d-inline-flex align-items-center p-1 rounded-pill">
                    <li><a href="{{ route('buyer.dashboard') }}" data-userlayout="buyer">{{ __('web.user.buyer') }}</a></li>
                    <li><a href="{{ route('seller.dashboard') }}" class="active" data-userlayout="seller">{{ __('web.user.seller') }}</a></li>
                </ul>
            </div>
            <div class="nav-item dropdown flag-nav nav-item-box">
                <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);" role="button">
                    <img src="{{ asset('backend/assets/img/flags/' . app()->getLocale() . '.svg') }}"
                        alt="{{ strtoupper(app()->getLocale()) }} language flag"
                        class="img-fluid">
                </a>
            ...
            <a href="{{ route('sellerprofile') }}" class="dropdown-toggle d-flex align-items-center">
