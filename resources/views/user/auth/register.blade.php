                        ...
                        <form id="userRegisterForm">
                            <div class="login-userset">
                                <div class="login-logo">
                                    <img src="/frontend/assets/img/logo.svg" alt="img">
                                </div>
                                <div class="login-card">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-wrap form-focus">
                                            ...
                                            <input type="text" class="form-control floating" id="username" name="username" placeholder="">
                                    ...
                                    <button type="submit" class="btn btn-primary use-register-btn">Sign Up</button>

                                </div>
                                <div class="acc-in">
                                    <p>Don’t have an account? <a href={{ route('user-login') }}>Sign In</a></p>
                                </div>
                            </div>
                        </form>
                    </div>
