                        ...
                        <form  id="changePasswordForm">
                            <div class="login-userset">
                                <div class="login-logo">
                                   <img src="/frontend/assets/assets/img/logo.svg" alt="img">
                               </div>
                               <input type="hidden" name="email" id="email">
                               <div class="login-card">
                                   <div class="login-heading text-start">
                                       <h3>Change Password</h3>
                                       <p>Your new password must be different from the previous.</p>
                                   </div>
                                   <div>
                                        ...
                                        <div class="form-wrap form-focus pass-group">
                                            ...
                                            <input type="password" class="pass-inputs form-control floating" name="current_password" id="current_password">
                               ...
                               <div class="acc-in">
                                    <p>Remember Password? <a href="signin.html">Sign in</a></p>
                               </div>
                           </div>
                        </form>
                    </div>
